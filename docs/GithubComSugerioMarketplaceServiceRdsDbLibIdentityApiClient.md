...
github_com_sugerio_marketplace_service_rds_db_lib_identity_api_client_form_dict = github_com_sugerio_marketplace_service_rds_db_lib_identity_api_client.from_dict(github_com_sugerio_marketplace_service_rds_db_lib_identity_api_client_dict)
```
