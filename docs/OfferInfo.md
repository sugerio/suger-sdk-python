...
**commit_billing_interval_in_months** | **int** | Billing interval in months for commitDimensions | [optional] 
...
**usage_billing_interval_in_months** | **int** | Billing interval in months for billableDimensions | [optional] 
