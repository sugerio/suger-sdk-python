...
**aws_machine_learning_contract_duration** | **int** | For AWS machine learning contract private offer only. The contract duration of the offer in months. | [optional] 
...
**docusign_envelope_ids** | **Dict[str, str]** | The Docusign envelope IDs generated for the offer. The key is the contact ID, the value is the Docusign envelope ID. | [optional] 
...
**gcp_offer_deal_type** | [**GcpMarketplaceOfferDealType**](GcpMarketplaceOfferDealType.md) | Optional when creating GCP Marketplace private offer and replacement offer. | [optional] 
...
**gcp_sow_agreement_document** | [**GcpAgreementDocument**](GcpAgreementDocument.md) | Optional when creating GCP Marketplace private offer for professional services. | [optional] 
...
**pdf_url** | **str** | Not needed when creating stripe offer This URL points to the PDF version of the offer. | [optional] 
...
**snowflake_offer** | [**SnowflakeMarketplaceOffer**](SnowflakeMarketplaceOffer.md) | The private offer for Snowflake marketplace. Only applicable for Snowflake Marketplace offers. | [optional] 
