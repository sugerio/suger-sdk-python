    ...
    def make_instance(self, include_optional) -> OfferInfo:
        ...
        if include_optional:
            return OfferInfo(
                ...
                commits = [
                    {"types":["types","types"],"quantity":2,"length":7,"description":"description","type":"{}","maximumUsers":930144,"rate":4.145608029883936,"isUserCreated":true,"minimumUsers":361608,"name":"name","term":"term","category":"category","termEndTime":"termEndTime","key":"key","timeUnit":"{}"}
                    ],
                currency = '',
                dimensions = [
                    {"priceTiers":[{"startingUsageAmount":"startingUsageAmount","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"},"fromAmount":1.2315135367772556},{"startingUsageAmount":"startingUsageAmount","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"},"fromAmount":1.2315135367772556}],"types":["types","types"],"description":"description","planName":"planName","usageCount":"{}","rate":1.4894159098541704,"includedBaseQuantities":[{"quantity":7.386281948385884,"isInfinite":true,"recurringUnit":"Monthly"},{"quantity":7.386281948385884,"isInfinite":true,"recurringUnit":"Monthly"}],"valueType":"{}","name":"name","planId":"planId","category":"category","key":"key","skuId":"skuId"}
                    ],
                discount_percentage = 1.337,
                eula_type = '',
                eula_url = '',
                ...
                gcp_plans = [
                    {"priceInfo":{"usageFees":[{"priceTiers":[{"startingUsageAmount":"startingUsageAmount","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"},"fromAmount":1.2315135367772556},{"startingUsageAmount":"startingUsageAmount","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"},"fromAmount":1.2315135367772556}],"metricId":"metricId","displayQuantity":1},{"priceTiers":[{"startingUsageAmount":"startingUsageAmount","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"},"fromAmount":1.2315135367772556},{"startingUsageAmount":"startingUsageAmount","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"},"fromAmount":1.2315135367772556}],"metricId":"metricId","displayQuantity":1}],"subscriptionPlans":[{"period":"period","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"}},{"period":"period","price":{"nanos":1,"units":"units","currencyCode":"currencyCode"}}],"description":"description","priceModel":"FREE"},"purchaseMode":"PURCHASE_MODE_PRIVATE","name":"name","title":"title","featureValues":[{"featureValue":"featureValue","featureTitle":"featureTitle","featureName":"featureName","featureDescription":"featureDescription"},{"featureValue":"featureValue","featureTitle":"featureTitle","featureName":"featureName","featureDescription":"featureDescription"}]}
                    ],
