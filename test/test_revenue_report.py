...
class TestRevenueReport(unittest.TestCase):
    """RevenueReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevenueReport:
        """Test RevenueReport
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RevenueReport`
        """
        model = RevenueReport()  # noqa: E501
        if include_optional:
            return RevenueReport(
                ...
                partner = '',
                product_id = '',
                report_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                report_type = 'InvoicedAmount',
                revenue_records = [
                    openapi_client.models.revenue_record.RevenueRecord(
                        amount = 1.337, 
                        buyer_id = '', 
