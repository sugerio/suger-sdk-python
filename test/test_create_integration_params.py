...
from openapi_client.models.create_integration_params import CreateIntegrationParams  # noqa: E501

class TestCreateIntegrationParams(unittest.TestCase):
    """CreateIntegrationParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIntegrationParams:
        """Test CreateIntegrationParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIntegrationParams`
        """
        model = CreateIntegrationParams()  # noqa: E501
        if include_optional:
    ...
    def testCreateIntegrationParams(self):
        """Test CreateIntegrationParams"""
