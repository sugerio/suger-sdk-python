...
class WorkloadMetaInfo(BaseModel):
    ...
    __properties = ["baseAgreementId", "buyerIds", "contacts", "customMetaInfo", "errorMessages", "internalNote", "isAgreementBasedOffer", "isRenewalOffer", "notifications", "renewalOfferType"]
