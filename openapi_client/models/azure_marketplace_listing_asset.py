...
class AzureMarketplaceListingAsset(BaseModel):
    ...
    display_order: Optional[StrictInt] = Field(
        None, alias="displayOrder", description="minimum: 0"
    )
    ...
    language_id: Optional[StrictStr] = Field(
        None, alias="languageId", description="Max string length is 10."
    )
