...
class GcpMarketplacePrivateOffer(BaseModel):
    ...
    """
    active_entitlement: Optional[GcpMarketplaceEntitlement] = Field(None, alias="activeEntitlement")
    agency_enabled: Optional[StrictBool] = Field(None, alias="agencyEnabled")
    agreement: Optional[StrictStr] = Field(None, description="The resource name of agreement(entitlement) In format of \"projects/{projectNumber}/agreements/{agreementId}\"")
    ...
    customer_info: Optional[GcpMarketplacePrivateOfferCustomerInfo] = Field(None, alias="customerInfo")
    eula_agreement_document: Optional[GcpMarketplaceDocument] = Field(None, alias="eulaAgreementDocument")
    existing_offer_data: Optional[GcpMarketplaceExistingOfferData] = Field(None, alias="existingOfferData")
    ...
    lifecycle_state: Optional[StrictStr] = Field(None, alias="lifecycleState", description="such as \"PUBLISHED\"")
    metric_information: Optional[GcpMarketplacePrivateOfferMetricInformation] = Field(None, alias="metricInformation")
    migration_metadata: Optional[GcpMarketplacePrivateOfferMigrationMetadata] = Field(None, alias="migrationMetadata")
    name: Optional[StrictStr] = Field(None, description="In format of \"projects/{projectNumber}/services/{serviceName, such as service-name.endpoints.gcp-project-id.cloud.goog}/privateOffers/{privateOfferId}\"")
    offer_id: Optional[StrictStr] = Field(None, alias="offerId", description="GCP private offer ID")
    offer_source: Optional[StrictStr] = Field(None, alias="offerSource", description="such as \"OFFER\"")
    offer_state: Optional[GcpMarketplacePrivateOfferState] = Field(None, alias="offerState")
    ...
    price_model_type: Optional[GcpMarketplacePrivateOfferPriceModelType] = Field(None, alias="priceModelType")
    provider_cancellation_internal_note: Optional[StrictStr] = Field(None, alias="providerCancellationInternalNote")
    provider_info: Optional[GcpMarketplacePrivateOfferProviderInfo] = Field(None, alias="providerInfo")
    provider_internal_note: Optional[StrictStr] = Field(None, alias="providerInternalNote")
    provider_public_note: Optional[StrictStr] = Field(None, alias="providerPublicNote")
    purchase_channel: Optional[GcpMarketplacePurchaseChannel] = Field(None, alias="purchaseChannel")
    purchase_time: Optional[datetime] = Field(None, alias="purchaseTime")
    replacement_metadata: Optional[GcpMarketplacePrivateOfferReplacementMetadata] = Field(None, alias="replacementMetadata")
    ...
    use_legacy_partner_eula: Optional[StrictBool] = Field(None, alias="useLegacyPartnerEula")
    user_labels: Optional[conlist(StrictStr)] = Field(None, alias="userLabels")
    __properties = ["activeEntitlement", "agencyEnabled", "agreement", "cancelTime", "customEula", "customerInfo", "eulaAgreementDocument", "existingOfferData", "expireTime", "features", "installmentTimeline", "lifecycleState", "metricInformation", "migrationMetadata", "name", "offerId", "offerSource", "offerState", "offerTerm", "paymentSchedule", "policies", "priceModel", "priceModelType", "providerCancellationInternalNote", "providerInfo", "providerInternalNote", "providerPublicNote", "purchaseChannel", "purchaseTime", "replacementMetadata", "serviceLevel", "updateTime", "useLegacyPartnerEula", "userLabels"]
    ...
    def from_dict(cls, obj: dict) -> GcpMarketplacePrivateOffer:
        ...
        _obj = GcpMarketplacePrivateOffer.parse_obj({
            "active_entitlement": GcpMarketplaceEntitlement.from_dict(obj.get("activeEntitlement")) if obj.get("activeEntitlement") is not None else None,
            ...
            "customer_info": GcpMarketplacePrivateOfferCustomerInfo.from_dict(obj.get("customerInfo")) if obj.get("customerInfo") is not None else None,
            "eula_agreement_document": GcpMarketplaceDocument.from_dict(obj.get("eulaAgreementDocument")) if obj.get("eulaAgreementDocument") is not None else None,
            "existing_offer_data": GcpMarketplaceExistingOfferData.from_dict(obj.get("existingOfferData")) if obj.get("existingOfferData") is not None else None,
            "expire_time": obj.get("expireTime"),
            "features": [GcpMarketplaceProductFeatureValue.from_dict(_item) for _item in obj.get("features")] if obj.get("features") is not None else None,
            ...
            "metric_information": GcpMarketplacePrivateOfferMetricInformation.from_dict(obj.get("metricInformation")) if obj.get("metricInformation") is not None else None,
            "migration_metadata": GcpMarketplacePrivateOfferMigrationMetadata.from_dict(obj.get("migrationMetadata")) if obj.get("migrationMetadata") is not None else None,
            "name": obj.get("name"),
            ...
            "provider_cancellation_internal_note": obj.get("providerCancellationInternalNote"),
            "provider_info": GcpMarketplacePrivateOfferProviderInfo.from_dict(obj.get("providerInfo")) if obj.get("providerInfo") is not None else None,
            "provider_internal_note": obj.get("providerInternalNote"),
            "provider_public_note": obj.get("providerPublicNote"),
            "purchase_channel": GcpMarketplacePurchaseChannel.from_dict(obj.get("purchaseChannel")) if obj.get("purchaseChannel") is not None else None,
            "purchase_time": obj.get("purchaseTime"),
            "replacement_metadata": GcpMarketplacePrivateOfferReplacementMetadata.from_dict(obj.get("replacementMetadata")) if obj.get("replacementMetadata") is not None else None,
