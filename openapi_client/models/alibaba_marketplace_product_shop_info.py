...
class AlibabaMarketplaceProductShopInfo(BaseModel):
    ...
    telephones: Optional[AlibabaMarketplaceProductShopInfoTelephones] = Field(
        None, alias="Telephones"
    )
    wang_wangs: Optional[AlibabaMarketplaceProductShopInfoWangWangs] = Field(
        None, alias="WangWangs"
    )
        ...
        _obj = AlibabaMarketplaceProductShopInfo.parse_obj(
            {
                ...
                "id": obj.get("Id"),
                "name": obj.get("Name"),
                "telephones": AlibabaMarketplaceProductShopInfoTelephones.from_dict(
                    obj.get("Telephones")
                )
                if obj.get("Telephones") is not None
                else None,
                "wang_wangs": AlibabaMarketplaceProductShopInfoWangWangs.from_dict(
                    obj.get("WangWangs")
                )
                if obj.get("WangWangs") is not None
                else None,
            }
        )
        return _obj
