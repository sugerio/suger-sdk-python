...
class ClientDescribeInstanceResponseBodyModulesModuleProperties(BaseModel):
    ...
    """
    var_property: Optional[conlist(ClientDescribeInstanceResponseBodyModulesModulePropertiesProperty)] = Field(None, alias="Property")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientDescribeInstanceResponseBodyModulesModuleProperties:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientDescribeInstanceResponseBodyModulesModuleProperties:
        """Create an instance of ClientDescribeInstanceResponseBodyModulesModuleProperties from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientDescribeInstanceResponseBodyModulesModuleProperties.parse_obj(obj)

        _obj = ClientDescribeInstanceResponseBodyModulesModuleProperties.parse_obj({
            "var_property": [ClientDescribeInstanceResponseBodyModulesModulePropertiesProperty.from_dict(_item) for _item in obj.get("Property")] if obj.get("Property") is not None else None
        })
        return _obj
