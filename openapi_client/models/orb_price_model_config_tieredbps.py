...
class OrbPriceModelConfigTIEREDBPS(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrbPriceModelConfigTIEREDBPS:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrbPriceModelConfigTIEREDBPS:
        """Create an instance of OrbPriceModelConfigTIEREDBPS from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrbPriceModelConfigTIEREDBPS.parse_obj(obj)

        _obj = OrbPriceModelConfigTIEREDBPS.parse_obj({
