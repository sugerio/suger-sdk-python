...
class AlibabaMarketplaceProduct(BaseModel):
    ...
    product_extras: Optional[AlibabaMarketplaceProductExtras] = Field(None, alias="ProductExtras")
    product_skus: Optional[AlibabaMarketplaceProductSkus] = Field(None, alias="ProductSkus")
    ...
    shop_info: Optional[AlibabaMarketplaceProductShopInfo] = Field(None, alias="ShopInfo")
    ...
    __properties = ["AuditFailMsg", "AuditStatus", "AuditTime", "Code", "Description", "FrontCategoryId", "GmtCreated", "GmtModified", "Name", "PicUrl", "ProductExtras", "ProductSkus", "RequestId", "Score", "ShopInfo", "ShortDescription", "Status", "SupplierPk", "Type", "UseCount"]
    ...
    def from_dict(cls, obj: dict) -> AlibabaMarketplaceProduct:
        ...
        _obj = AlibabaMarketplaceProduct.parse_obj({
            ...
            "product_extras": AlibabaMarketplaceProductExtras.from_dict(obj.get("ProductExtras")) if obj.get("ProductExtras") is not None else None,
            "product_skus": AlibabaMarketplaceProductSkus.from_dict(obj.get("ProductSkus")) if obj.get("ProductSkus") is not None else None,
            "request_id": obj.get("RequestId"),
            "score": obj.get("Score"),
            "shop_info": AlibabaMarketplaceProductShopInfo.from_dict(obj.get("ShopInfo")) if obj.get("ShopInfo") is not None else None,
