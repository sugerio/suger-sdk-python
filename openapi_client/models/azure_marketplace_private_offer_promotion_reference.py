...
class AzureMarketplacePrivateOfferPromotionReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureMarketplacePrivateOfferPromotionReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureMarketplacePrivateOfferPromotionReference:
