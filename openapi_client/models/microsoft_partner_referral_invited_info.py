...
class MicrosoftPartnerReferralInvitedInfo(BaseModel):
    """
    ...
    __properties = ["organizationId", "organizationName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MicrosoftPartnerReferralInvitedInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MicrosoftPartnerReferralInvitedInfo:
        """Create an instance of MicrosoftPartnerReferralInvitedInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MicrosoftPartnerReferralInvitedInfo.parse_obj(obj)

        _obj = MicrosoftPartnerReferralInvitedInfo.parse_obj({
