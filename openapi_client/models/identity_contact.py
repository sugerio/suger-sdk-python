...
class IdentityContact(BaseModel):
    ...
    id: Optional[StrictStr] = Field(None, description="This is generated by Suger. When you create a new contact, do not provide.")
    ...
    __properties = ["creationTime", "emailAddress", "id", "info", "lastUpdateTime", "name", "organizationID"]
    ...
    def from_dict(cls, obj: dict) -> IdentityContact:
        ...
        _obj = IdentityContact.parse_obj({
            ...
            "id": obj.get("id"),
            "info": IdentityConctactInfo.from_dict(obj.get("info")) if obj.get("info") is not None else None,
