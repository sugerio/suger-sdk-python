...
class IdentityIntegration(BaseModel):
    ...
    __properties = ["createdBy", "creationTime", "info", "lastUpdateTime", "lastUpdatedBy", "organizationID", "partner", "service", "status"]
    ...
    def partner_validate_enum(cls, value):
        ...
        if value not in ('AWS', 'AZURE', 'GCP', 'ALIBABA'):
            raise ValueError("must be one of enum values ('AWS', 'AZURE', 'GCP', 'ALIBABA')")
        return value
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('CREATED', 'VERIFIED', 'NOT_VERIFIED'):
            raise ValueError("must be one of enum values ('CREATED', 'VERIFIED', 'NOT_VERIFIED')")
        return value
