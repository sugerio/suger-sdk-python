...
class AwsMarketplaceEventBridgeEventProduct(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AwsMarketplaceEventBridgeEventProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AwsMarketplaceEventBridgeEventProduct:
