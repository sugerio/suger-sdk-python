...
class GcpMarketplaceProductPurchaseSpec(BaseModel):
    ...
    metrics: Optional[conlist(GcpMarketplaceProductMeteringMetric)] = Field(
        None, description="GCP Marketplace Product Usage Metering Dimension/Metric"
    )
    purchase_option_specs: Optional[
        conlist(GcpMarketplaceProductPurchaseOptionSpec)
    ] = Field(
        None,
        alias="purchaseOptionSpecs",
    ...
    def from_dict(cls, obj: dict) -> GcpMarketplaceProductPurchaseSpec:
        ...
        _obj = GcpMarketplaceProductPurchaseSpec.parse_obj(
            {
                "features": [
                    GcpMarketplaceProductFeature.from_dict(_item)
                ...
                "purchase_option_specs": [
                    ...
                    for _item in obj.get("purchaseOptionSpecs")
                ]
                if obj.get("purchaseOptionSpecs") is not None
                else None,
            }
        )
        return _obj
