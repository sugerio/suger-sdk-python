...
class AzureMarketplacePriceAndAvailabilitySystemMeterPrice(BaseModel):
    ...
    __properties = ["price", "priceInputOption", "prices"]
    ...
    def price_input_option_validate_enum(cls, value):
        ...
        if value not in ('perCore', 'perEveryCoreInCluster', 'perNode', 'perEveryNodeInCluster', 'perPod', 'perCluster'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureMarketplacePriceAndAvailabilitySystemMeterPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureMarketplacePriceAndAvailabilitySystemMeterPrice:
        """Create an instance of AzureMarketplacePriceAndAvailabilitySystemMeterPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AzureMarketplacePriceAndAvailabilitySystemMeterPrice.parse_obj(obj)

        _obj = AzureMarketplacePriceAndAvailabilitySystemMeterPrice.parse_obj({
            "price": obj.get("price"),
