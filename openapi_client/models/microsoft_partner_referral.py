...
class MicrosoftPartnerReferral(BaseModel):
    ...
    __properties = ["acceptedDateTime", "callToAction", "campaignId", "closedDateTime", "consent", "createdDateTime", "createdVia", "customerProfile", "dealSensitivity", "details", "direction", "eTag", "engagementId", "exception", "expirationDateTime", "favorite", "id", "inviteContext", "isAutoRegistrationEnabled", "isSpam", "lastModifiedVia", "links", "mpnId", "name", "organizationId", "organizationName", "qualification", "quality", "referralProgram", "referralSource", "registrationStatus", "registrations", "salesStage", "status", "substatus", "tags", "target", "team", "trackingInfo", "type", "updatedDateTime"]
