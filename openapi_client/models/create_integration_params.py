...
class CreateIntegrationParams(BaseModel):
    ...
    __properties = ["createdBy", "info", "organizationID", "partner", "service"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateIntegrationParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateIntegrationParams:
