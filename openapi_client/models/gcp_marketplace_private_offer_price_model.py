...
class GcpMarketplacePrivateOfferPriceModel(BaseModel):
    ...
    """
    base_offer: Optional[StrictStr] = Field(None, alias="baseOffer", description="in format of \"projects/{projectNumber}/services/service-name.endpoints.gcp-project-id.cloud.goog/standardOffers/base-offer-id\"")
    commitment: Optional[GcpMarketplacePrivateOfferPriceModelCommitment] = None
    fixed_price: Optional[GcpMarketplacePrivateOfferPriceModelFixed] = Field(None, alias="fixedPrice")
    ...
    previous_credit_balance_policy: Optional[StrictStr] = Field(None, alias="previousCreditBalancePolicy", description="such as \"PREVIOUS_CREDIT_BALANCE_POLICY_UNSPECIFIED\"")
    __properties = ["baseOffer", "commitment", "fixedPrice", "oneTimeCredit", "overage", "payg", "previousCreditBalancePolicy"]
    ...
    def from_dict(cls, obj: dict) -> GcpMarketplacePrivateOfferPriceModel:
        ...
        _obj = GcpMarketplacePrivateOfferPriceModel.parse_obj({
            ...
            "commitment": GcpMarketplacePrivateOfferPriceModelCommitment.from_dict(obj.get("commitment")) if obj.get("commitment") is not None else None,
            "fixed_price": GcpMarketplacePrivateOfferPriceModelFixed.from_dict(obj.get("fixedPrice")) if obj.get("fixedPrice") is not None else None,
            "one_time_credit": GcpPriceValue.from_dict(obj.get("oneTimeCredit")) if obj.get("oneTimeCredit") is not None else None,
            "overage": GcpMarketplacePrivateOfferPriceModelOverage.from_dict(obj.get("overage")) if obj.get("overage") is not None else None,
            "payg": GcpMarketplacePrivateOfferPriceModelPayg.from_dict(obj.get("payg")) if obj.get("payg") is not None else None,
            "previous_credit_balance_policy": obj.get("previousCreditBalancePolicy")
        })
        return _obj
