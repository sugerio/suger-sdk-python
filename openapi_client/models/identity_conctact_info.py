...
class IdentityConctactInfo(BaseModel):
    ...
    __properties = ["companyLocation", "companyName", "phoneNumber", "role"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityConctactInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityConctactInfo:
