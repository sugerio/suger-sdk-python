...
class GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventOkResponse(
    BaseModel
):
    """
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventOkResponse.parse_obj(
                obj
            )
