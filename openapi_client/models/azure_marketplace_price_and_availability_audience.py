...
class AzureMarketplacePriceAndAvailabilityAudience(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('none', 'subscription', 'ea', 'msdn', 'tenant', 'email'):
            raise ValueError("must be one of enum values ('none', 'subscription', 'ea', 'msdn', 'tenant', 'email')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureMarketplacePriceAndAvailabilityAudience:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureMarketplacePriceAndAvailabilityAudience:
