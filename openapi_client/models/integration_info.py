...
class IntegrationInfo(BaseModel):
    ...
    IntegrationInfo
    """
    alibaba_integration: Optional[AlibabaMarketplaceIntegration] = Field(None, alias="alibabaIntegration")
    aws_ace_integration: Optional[AwsAceIntegration] = Field(None, alias="awsAceIntegration")
    aws_integration: Optional[AwsMarketplaceIntegration] = Field(None, alias="awsIntegration")
    azure_integration: Optional[AzureIntegration] = Field(None, alias="azureIntegration")
    gcp_integration: Optional[GcpIntegration] = Field(None, alias="gcpIntegration")
    hubspot_crm_integration: Optional[HubspotCrmIntegration] = Field(None, alias="hubspotCrmIntegration")
    metronome_integration: Optional[MetronomeIntegration] = Field(None, alias="metronomeIntegration")
    orb_integration: Optional[OrbIntegration] = Field(None, alias="orbIntegration")
    salesforce_crm_integration: Optional[SalesforceCrmIntegration] = Field(None, alias="salesforceCrmIntegration")
    slack_integration: Optional[SlackIntegration] = Field(None, alias="slackIntegration")
    __properties = ["alibabaIntegration", "awsAceIntegration", "awsIntegration", "azureIntegration", "gcpIntegration", "hubspotCrmIntegration", "metronomeIntegration", "orbIntegration", "salesforceCrmIntegration", "slackIntegration"]
    ...
    def to_dict(self):
        ...
        if self.salesforce_crm_integration:
            _dict['salesforceCrmIntegration'] = self.salesforce_crm_integration.to_dict()
    ...
    def from_dict(cls, obj: dict) -> IntegrationInfo:
        ...
        _obj = IntegrationInfo.parse_obj({
            "alibaba_integration": AlibabaMarketplaceIntegration.from_dict(obj.get("alibabaIntegration")) if obj.get("alibabaIntegration") is not None else None,
            "aws_ace_integration": AwsAceIntegration.from_dict(obj.get("awsAceIntegration")) if obj.get("awsAceIntegration") is not None else None,
            "aws_integration": AwsMarketplaceIntegration.from_dict(obj.get("awsIntegration")) if obj.get("awsIntegration") is not None else None,
            "azure_integration": AzureIntegration.from_dict(obj.get("azureIntegration")) if obj.get("azureIntegration") is not None else None,
            "gcp_integration": GcpIntegration.from_dict(obj.get("gcpIntegration")) if obj.get("gcpIntegration") is not None else None,
            "hubspot_crm_integration": HubspotCrmIntegration.from_dict(obj.get("hubspotCrmIntegration")) if obj.get("hubspotCrmIntegration") is not None else None,
            "metronome_integration": MetronomeIntegration.from_dict(obj.get("metronomeIntegration")) if obj.get("metronomeIntegration") is not None else None,
            "orb_integration": OrbIntegration.from_dict(obj.get("orbIntegration")) if obj.get("orbIntegration") is not None else None,
            "salesforce_crm_integration": SalesforceCrmIntegration.from_dict(obj.get("salesforceCrmIntegration")) if obj.get("salesforceCrmIntegration") is not None else None,
            "slack_integration": SlackIntegration.from_dict(obj.get("slackIntegration")) if obj.get("slackIntegration") is not None else None
        })
        return _obj
