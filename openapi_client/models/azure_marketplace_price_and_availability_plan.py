...
class AzureMarketplacePriceAndAvailabilityPlan(BaseModel):
    ...
    meter_define: Optional[StrictStr] = Field(None, alias="meterDefine")
    ...
    __properties = ["$schema", "audience", "billingTag", "id", "markets", "meterDefine", "plan", "pricing", "privateAudiences", "product", "resourceName", "softwareReservation", "trial", "validations", "visibility"]
    ...
    def from_dict(cls, obj: dict) -> AzureMarketplacePriceAndAvailabilityPlan:
        ...
        _obj = AzureMarketplacePriceAndAvailabilityPlan.parse_obj({
            ...
            "meter_define": obj.get("meterDefine"),
            "plan": obj.get("plan"),
