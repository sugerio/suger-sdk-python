...
class PartnerUsageMeteringConfig(BaseModel):
    ...
    dimension_mapping: Optional[Dict[str, UsageMeteringDimensionMappingValue]] = Field(
        None,
        alias="dimensionMapping",
        description="The mapping of the source dimension key to the destination dimension key of the usage metering.",
    )
    enable_commit_with_additional_usage_at_list_price: Optional[StrictBool] = Field(
        None,
        alias="enableCommitWithAdditionalUsageAtListPrice",
    ...
    enable_commit_with_additional_usage_metering: Optional[StrictBool] = Field(
        None,
        alias="enableCommitWithAdditionalUsageMetering",
        description="Enable the commit with additional usage metering. The default is false, which means all usage records are reported to partner no matter how much is the commit. If set to true, the usage records will be reported to partner only if the current commit has been exhausted.",
    )
    enable_dimension_mapping: Optional[StrictBool] = Field(
        None,
        alias="enableDimensionMapping",
        ...
        _obj = PartnerUsageMeteringConfig.parse_obj(
            {
                ...
                "enable_commit_with_additional_usage_at_list_price": obj.get(
                    "enableCommitWithAdditionalUsageAtListPrice"
                ),
                "enable_commit_with_additional_usage_metering": obj.get(
                    "enableCommitWithAdditionalUsageMetering"
                ),
