...
class AzureMarketplacePrivateOffer(BaseModel):
    ...
    accept_by: Optional[datetime] = Field(None, alias="acceptBy", description="in format YYYY-MM-DD")
    acceptance_links: Optional[conlist(AzureMarketplacePrivateOfferAcceptanceLink)] = Field(None, alias="acceptanceLinks")
    ...
    id: Optional[StrictStr] = Field(None, description="in format of \"private-offer/private-offer-durable-id\"")
    last_modified: Optional[datetime] = Field(None, alias="lastModified", description="in format YYYY-MM-DD")
    name: Optional[StrictStr] = None
    notification_contacts: Optional[conlist(StrictStr)] = Field(None, alias="notificationContacts", description="array of email addresses of the users to be notified of any changes in the private offer status.")
    offer_pricing_type: Optional[AzureMarketplaceOfferPricingType] = Field(None, alias="offerPricingType")
    ...
    pricing: Optional[conlist(AzureMarketplacePrivateOfferPricing)] = Field(None, description="Up to 10 pricing entries are allowed.")
    private_offer_type: Optional[AzureMarketplacePrivateOfferType] = Field(None, alias="privateOfferType")
    resource_name: Optional[StrictStr] = Field(None, alias="resourceName")
    start: Optional[datetime] = Field(None, description="in format YYYY-MM-DD, if VariableStartDate = true, this field should be empty.")
    state: Optional[AzureMarketplacePrivateOfferState] = None
    sub_state: Optional[AzureMarketplacePrivateOfferSubState] = Field(None, alias="subState")
    terms_and_conditions_doc_sas_url: Optional[StrictStr] = Field(None, alias="termsAndConditionsDocSasUrl", description="Only applicable to private offers with privateOfferType = customerPromotion || cspPromotion")
    terms_and_conditions_docs: Optional[conlist(AzureMarketplacePrivateOfferTermsDoc)] = Field(None, alias="termsAndConditionsDocs", description="Only applicable to private offers with privateOfferType = multipartyPromotionOriginator || multipartyPromotionChannelPartner")
    upgraded_from: Optional[AzureMarketplacePrivateOfferPromotionReference] = Field(None, alias="upgradedFrom")
    ...
    __properties = ["$schema", "acceptBy", "acceptanceLinks", "beneficiaries", "eTag", "end", "id", "lastModified", "name", "notificationContacts", "offerPricingType", "partners", "preparedBy", "pricing", "privateOfferType", "resourceName", "start", "state", "subState", "termsAndConditionsDocSasUrl", "termsAndConditionsDocs", "upgradedFrom", "validations", "variableStartDate"]
    ...
    def from_dict(cls, obj: dict) -> AzureMarketplacePrivateOffer:
        ...
        _obj = AzureMarketplacePrivateOffer.parse_obj({
            ...
            "acceptance_links": [AzureMarketplacePrivateOfferAcceptanceLink.from_dict(_item) for _item in obj.get("acceptanceLinks")] if obj.get("acceptanceLinks") is not None else None,
            "beneficiaries": [AzureMarketplacePrivateOfferBeneficiary.from_dict(_item) for _item in obj.get("beneficiaries")] if obj.get("beneficiaries") is not None else None,
            "e_tag": obj.get("eTag"),
            "end": obj.get("end"),
            "id": obj.get("id"),
            ...
            "partners": [AzureMarketplacePrivateOfferPartner.from_dict(_item) for _item in obj.get("partners")] if obj.get("partners") is not None else None,
            "prepared_by": obj.get("preparedBy"),
            "pricing": [AzureMarketplacePrivateOfferPricing.from_dict(_item) for _item in obj.get("pricing")] if obj.get("pricing") is not None else None,
            "private_offer_type": obj.get("privateOfferType"),
            "resource_name": obj.get("resourceName"),
            "start": obj.get("start"),
            "state": obj.get("state"),
            "sub_state": obj.get("subState"),
            "terms_and_conditions_doc_sas_url": obj.get("termsAndConditionsDocSasUrl"),
            "terms_and_conditions_docs": [AzureMarketplacePrivateOfferTermsDoc.from_dict(_item) for _item in obj.get("termsAndConditionsDocs")] if obj.get("termsAndConditionsDocs") is not None else None,
            "upgraded_from": AzureMarketplacePrivateOfferPromotionReference.from_dict(obj.get("upgradedFrom")) if obj.get("upgradedFrom") is not None else None,
