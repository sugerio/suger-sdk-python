...
class MetronomeIntegration(BaseModel):
    ...
    billing_mode: Optional[MetronomeBillingMode] = Field(None, alias="billingMode")
    ...
    __properties = ["apiToken", "billableMetricFullList", "billableMetricWhitelist", "billingMode", "enableAutoReportUsage", "enableBillableMetricWhitelist", "secretKey"]
