...
class AzureMarketplaceDeprecationScheduleAlternative(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureMarketplaceDeprecationScheduleAlternative:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureMarketplaceDeprecationScheduleAlternative:
