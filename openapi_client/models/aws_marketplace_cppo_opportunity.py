...
class AwsMarketplaceCppoOpportunity(BaseModel):
    ...
    buyer_ids: Optional[conlist(StrictStr)] = Field(
        None,
        alias="buyerIds",
        description="The AWS Account ID of buyer that are specified by the ISV/Seller in this CPPO Opportunity.",
    )
    buyer_names: Optional[conlist(StrictStr)] = Field(None, alias="buyerNames")
    contract_duration_in_days: Optional[StrictInt] = Field(
        None, alias="contractDurationInDays"
    )
    created_by: Optional[StrictStr] = Field(
        None,
        alias="createdBy",
        description="The AWS Account ID of the ISV/Seller who create this CPPO Opportunity.",
    )
    created_date: Optional[StrictStr] = Field(
        None,
        alias="createdDate",
        description='in format of "Wed Sep 13 17:50:07 UTC 2023"',
    )
    custom_price_terms: Optional[AwsMarketplaceCppoPriceTerms] = Field(
        None, alias="customPriceTerms"
    )
    discount: Optional[StrictStr] = Field(None, description='in format of "10.0" (10%)')
    discount_percent: Optional[Union[StrictFloat, StrictInt]] = Field(
        None, alias="discountPercent"
    )
    discount_type: Optional[AwsMarketplaceCppoDiscountType] = Field(
    ...
    expiration_date: Optional[StrictStr] = Field(
        ...
        description='in format of "Thu Nov 30 23:59:59 UTC 2023"',
    )
    listing_fee_renewal: Optional[StrictBool] = Field(None, alias="listingFeeRenewal")
    manufacturer_id: Optional[StrictStr] = Field(
        None, alias="manufacturerId", description="The AWS Account ID of the ISV/Seller"
    )
    manufacturer_name: Optional[StrictStr] = Field(
        None, alias="manufacturerName", description="The name of the ISV/Seller"
    )
    offers_count: Optional[StrictInt] = Field(None, alias="offersCount")
    opportunity_discription: Optional[StrictStr] = Field(
        None, alias="opportunityDiscription"
    )
    opportunity_duration_type: Optional[AwsMarketplaceCppoDurationType] = Field(
        None, alias="opportunityDurationType"
    )
    opportunity_eula: Optional[AwsMarketplaceCppoOpportunityEula] = Field(
        None, alias="opportunityEula"
    )
    ...
    opportunity_rcmp: Optional[AwsMarketplaceCppoOpportunityEula] = Field(
        None, alias="opportunityRcmp"
    )
    partner_id: Optional[StrictStr] = Field(
        None, alias="partnerId", description="The AWS Account ID of the Channel Partner"
    )
    partner_name: Optional[StrictStr] = Field(
        None, alias="partnerName", description="The name of the Channel Partner"
    )
    payment_terms: Optional[AwsMarketplaceCppoPaymentTerms] = Field(
        None, alias="paymentTerms"
    )
    product_id: Optional[StrictStr] = Field(
        None,
        alias="productId",
        description="The AWS Product ID from the ISV/Seller in this CPPO Opportunity.",
    )
    product_name: Optional[StrictStr] = Field(
        None,
        alias="productName",
        description="The AWS Product Name from the ISV/Seller in this CPPO Opportunity.",
    )
    product_type: Optional[StrictStr] = Field(
        None,
        alias="productType",
        description="The type of the AWS Product from the ISV/Seller in this CPPO Opportunity.",
    )
    sppo: Optional[StrictBool] = None
    status: Optional[StrictStr] = Field(
        None, description="The status of the CPPO Opportunity."
    )
    usage_allowed: Optional[StrictInt] = Field(
        None,
        alias="usageAllowed",
        description="How many times the CPPO Opportunity can be allowed to create CPPO Private Offer by the Channel Partner.",
    )
    __properties = [
        "buyerIds",
        "buyerNames",
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ("active", "restricted", "complete"):
            raise ValueError(
                "must be one of enum values ('active', 'restricted', 'complete')"
            )
        return value
        ...
        _obj = AwsMarketplaceCppoOpportunity.parse_obj(
            {
                ...
                "custom_price_terms": AwsMarketplaceCppoPriceTerms.from_dict(
                    obj.get("customPriceTerms")
                )
                if obj.get("customPriceTerms") is not None
                else None,
                ...
                "opportunity_eula": AwsMarketplaceCppoOpportunityEula.from_dict(
                    obj.get("opportunityEula")
                )
                if obj.get("opportunityEula") is not None
                else None,
                "opportunity_id": obj.get("opportunityId"),
                "opportunity_name": obj.get("opportunityName"),
                "opportunity_rcmp": AwsMarketplaceCppoOpportunityEula.from_dict(
                    obj.get("opportunityRcmp")
                )
                if obj.get("opportunityRcmp") is not None
                else None,
                "partner_id": obj.get("partnerId"),
                "partner_name": obj.get("partnerName"),
                "payment_terms": AwsMarketplaceCppoPaymentTerms.from_dict(
