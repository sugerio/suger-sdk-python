...
# Script to regenerate OpenAPI specification from [marketplace-service] and update Python SDK
...
# Step 4: Copy the converted OpenAPI spec to Python SDK project
echo "📋 Copying converted OpenAPI specification to Python SDK project..."
...
echo ""
echo "📝 Next steps:"
echo "  Regenerated Python SDK code"