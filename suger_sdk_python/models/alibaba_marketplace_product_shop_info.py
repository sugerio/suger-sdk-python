...
class AlibabaMarketplaceProductShopInfo(BaseModel):
    ...
    """ # noqa: E501
    emails: Optional[StrictStr] = Field(default=None, alias="Emails")
    id: Optional[StrictInt] = Field(default=None, alias="Id")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    telephones: Optional[AlibabaMarketplaceProductShopInfoTelephones] = Field(default=None, alias="Telephones")
    wang_wangs: Optional[AlibabaMarketplaceProductShopInfoWangWangs] = Field(default=None, alias="WangWangs")
    __properties: ClassVar[List[str]] = ["Emails", "Id", "Name", "Telephones", "WangWangs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Name": obj.get("Name"),
            "Telephones": AlibabaMarketplaceProductShopInfoTelephones.from_dict(obj["Telephones"]) if obj.get("Telephones") is not None else None,
            "WangWangs": AlibabaMarketplaceProductShopInfoWangWangs.from_dict(obj["WangWangs"]) if obj.get("WangWangs") is not None else None
        })
        return _obj
