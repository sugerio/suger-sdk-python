...
class AzureMarketplaceResourceTarget(BaseModel):
    """
    ...
    def target_type_validate_enum(cls, value):
        ...
        if value not in set(['flight', 'sandbox', 'draft', 'preview', 'live', 'certification', 'retail']):
            raise ValueError("must be one of enum values ('flight', 'sandbox', 'draft', 'preview', 'live', 'certification', 'retail')")
        return value
