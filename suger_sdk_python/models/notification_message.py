...
class NotificationMessage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creationTime", "id", "info", "organizationID", "recipient", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "info": NotificationMessageInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
