...
class AlibabaMarketplaceProductExtras(BaseModel):
    ...
    """ # noqa: E501
    product_extra: Optional[List[AlibabaMarketplaceProductExtra]] = Field(default=None, alias="ProductExtra")
    __properties: ClassVar[List[str]] = ["ProductExtra"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.product_extra:
            for _item_product_extra in self.product_extra:
                if _item_product_extra:
                    _items.append(_item_product_extra.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ProductExtra": [AlibabaMarketplaceProductExtra.from_dict(_item) for _item in obj["ProductExtra"]] if obj.get("ProductExtra") is not None else None
        })
        return _obj
