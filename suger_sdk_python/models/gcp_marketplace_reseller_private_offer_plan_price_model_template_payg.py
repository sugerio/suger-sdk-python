...
class GcpMarketplaceResellerPrivateOfferPlanPriceModelTemplatePayg(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["discountTemplate", "period", "skuDiscountTemplates", "skuRepresentation"]
