...
class AzureMarketplacePrivateOfferBeneficiaryRecipient(BaseModel):
    ...
    recipient_type: Optional[StrictStr] = Field(default=None, alias="recipientType")
    __properties: ClassVar[List[str]] = ["id", "recipientType"]
    ...
    def recipient_type_validate_enum(cls, value):
        ...
        if value not in set(['cspCustomer', 'billingGroup']):
