...
class AlibabaMarketplaceProductSkuModules(BaseModel):
    ...
    """ # noqa: E501
    module: Optional[List[AlibabaMarketplaceProductSkuModule]] = Field(default=None, alias="Module")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Module": [AlibabaMarketplaceProductSkuModule.from_dict(_item) for _item in obj["Module"]] if obj.get("Module") is not None else None
        })
        return _obj
