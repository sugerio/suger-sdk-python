...
class AzureIncludedBaseQuantity(BaseModel):
    ...
    recurring_unit: Optional[StrictStr] = Field(default=None, alias="recurringUnit")
    __properties: ClassVar[List[str]] = ["isInfinite", "quantity", "recurringUnit"]

    @field_validator('recurring_unit')
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurringUnit": obj.get("recurringUnit")
        })
        return _obj
