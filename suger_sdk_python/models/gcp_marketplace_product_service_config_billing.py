...
class GcpMarketplaceProductServiceConfigBilling(BaseModel):
    ...
    """ # noqa: E501
    metrics: Optional[List[StrictStr]] = Field(default=None, description="The list of metrics that are available for billing for the product. In format of \"product-name.endpoints.gcp-project-id.cloud.goog/plan_name_metric_name\"")
