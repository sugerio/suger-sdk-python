...
class GcpMarketplaceUserAccountApproval(BaseModel):
    ...
    reason: Optional[StrictStr] = Field(default=None, description="An explanation for the state of the approval.")
    state: Optional[GcpMarketplaceUserAccountApprovalState] = None
    update_time: Optional[StrictStr] = Field(default=None, description="RFC3339 UTC timestamp", alias="updateTime")
    __properties: ClassVar[List[str]] = ["name", "reason", "state", "updateTime"]
