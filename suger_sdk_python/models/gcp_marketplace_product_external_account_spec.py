...
class GcpMarketplaceProductExternalAccountSpec(BaseModel):
    ...
    single_sign_on_uri: Optional[StrictStr] = Field(default=None, alias="singleSignOnUri")
    __properties: ClassVar[List[str]] = ["loginUri", "signupUri", "singleSignOnUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "singleSignOnUri": obj.get("singleSignOnUri")
        })
        return _obj
