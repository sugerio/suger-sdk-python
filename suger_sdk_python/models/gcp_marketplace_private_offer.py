...
class GcpMarketplacePrivateOffer(BaseModel):
    ...
    agreement_documents: Optional[GcpMarketplaceAgreementDocument] = Field(default=None, alias="agreementDocuments")
    ...
    policies: Optional[GcpMarketplacePrivateOfferPolicies] = Field(default=None, description="The policies of the offer.")
    ...
    private_offer_revenue_share: Optional[GcpMarketplacePrivateOfferRevenueShare] = Field(default=None, description="Revenue share information for this private offer", alias="privateOfferRevenueShare")
    ...
    __properties: ClassVar[List[str]] = ["activeEntitlement", "agencyEnabled", "agreement", "agreementDocuments", "cancelTime", "customerInfo", "existingOfferData", "expireTime", "features", "installmentTimeline", "lifecycleState", "metricInformation", "migrationMetadata", "name", "offerId", "offerSource", "offerState", "offerTerm", "offerTitle", "offerTitleAutoGenerated", "paymentSchedule", "policies", "priceModel", "priceModelType", "privateOfferRevenueShare", "providerCancellationInternalNote", "providerInfo", "providerInternalNote", "providerPublicNote", "purchaseChannel", "purchaseTime", "replacementMetadata", "resellerInfo", "serviceLevel", "updateTime", "useLegacyPartnerEula", "userLabels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of private_offer_revenue_share
        if self.private_offer_revenue_share:
            _dict['privateOfferRevenueShare'] = self.private_offer_revenue_share.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "agreementDocuments": GcpMarketplaceAgreementDocument.from_dict(obj["agreementDocuments"]) if obj.get("agreementDocuments") is not None else None,
            ...
            "policies": GcpMarketplacePrivateOfferPolicies.from_dict(obj["policies"]) if obj.get("policies") is not None else None,
            ...
            "privateOfferRevenueShare": GcpMarketplacePrivateOfferRevenueShare.from_dict(obj["privateOfferRevenueShare"]) if obj.get("privateOfferRevenueShare") is not None else None,
