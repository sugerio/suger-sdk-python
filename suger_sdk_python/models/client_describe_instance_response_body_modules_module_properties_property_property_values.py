...
class ClientDescribeInstanceResponseBodyModulesModulePropertiesPropertyPropertyValues(BaseModel):
    ...
    """ # noqa: E501
    property_value: Optional[List[ClientDescribeInstanceResponseBodyModulesModulePropertiesPropertyPropertyValuesPropertyValue]] = Field(default=None, alias="PropertyValue")
    __properties: ClassVar[List[str]] = ["PropertyValue"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.property_value:
            for _item_property_value in self.property_value:
                if _item_property_value:
                    _items.append(_item_property_value.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyValue": [ClientDescribeInstanceResponseBodyModulesModulePropertiesPropertyPropertyValuesPropertyValue.from_dict(_item) for _item in obj["PropertyValue"]] if obj.get("PropertyValue") is not None else None
        })
        return _obj
