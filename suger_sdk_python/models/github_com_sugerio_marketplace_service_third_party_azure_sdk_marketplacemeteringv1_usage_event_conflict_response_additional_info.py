...
class GithubComSugerioMarketplaceServiceThirdPartyAzureSdkMarketplacemeteringv1UsageEventConflictResponseAdditionalInfo(BaseModel):
    """
    GithubComSugerioMarketplaceServiceThirdPartyAzureSdkMarketplacemeteringv1UsageEventConflictResponseAdditionalInfo
    """ # noqa: E501
    accepted_message: Optional[GithubComSugerioMarketplaceServiceThirdPartyAzureSdkMarketplacemeteringv1UsageEventOkResponse] = Field(default=None, alias="acceptedMessage")
    __properties: ClassVar[List[str]] = ["acceptedMessage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acceptedMessage": GithubComSugerioMarketplaceServiceThirdPartyAzureSdkMarketplacemeteringv1UsageEventOkResponse.from_dict(obj["acceptedMessage"]) if obj.get("acceptedMessage") is not None else None
        })
        return _obj
