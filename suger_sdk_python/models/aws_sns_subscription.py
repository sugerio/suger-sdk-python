...
class AwsSnsSubscription(BaseModel):
    ...
    status: Optional[AwsSnsSubscriptionStatus] = Field(default=None, alias="Status")
    ...
    __properties: ClassVar[List[str]] = ["Endpoint", "Protocol", "Status", "SubscriptionArn", "TopicArn"]
