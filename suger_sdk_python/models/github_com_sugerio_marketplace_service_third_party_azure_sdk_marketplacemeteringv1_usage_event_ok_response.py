...
class GithubComSugerioMarketplaceServiceThirdPartyAzureSdkMarketplacemeteringv1UsageEventOkResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dimension", "effectiveStartTime", "messageTime", "planId", "quantity", "resourceId", "resourceUri", "status", "usageEventId"]
