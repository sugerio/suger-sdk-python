...
class AlibabaMarketplaceProductSkuModuleProperty(BaseModel):
    ...
    property_values: Optional[AlibabaMarketplaceProductSkuModulePropertyValues] = Field(default=None, alias="PropertyValues")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Key": obj.get("Key"),
            "Name": obj.get("Name"),
            "PropertyValues": AlibabaMarketplaceProductSkuModulePropertyValues.from_dict(obj["PropertyValues"]) if obj.get("PropertyValues") is not None else None,
