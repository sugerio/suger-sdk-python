...
class AzureMarketplacePriceAndAvailabilityCorePrice(BaseModel):
    ...
    price_per_core: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pricePerCore")
    price_per_core_size: Optional[Dict[str, Any]] = Field(default=None, alias="pricePerCoreSize")
    prices: Optional[List[AzureMarketplacePrice]] = None
    __properties: ClassVar[List[str]] = ["price", "priceInputOption", "pricePerCore", "pricePerCoreSize", "prices"]
    ...
    def price_input_option_validate_enum(cls, value):
        ...
        if value not in set(['free', 'flat', 'perCore', 'perCoreSize', 'perMarketAndCoreSize']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pricePerCore": obj.get("pricePerCore"),
            "pricePerCoreSize": obj.get("pricePerCoreSize"),
