...
class GcpMarketplaceResellerPrivateOfferPlanMarginPercentage(BaseModel):
    """
    GcpMarketplaceResellerPrivateOfferPlanMarginPercentage
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="The percentage value of the margin in the range of 0 to 100.")
