...
class ListUsageMeteringDailyRecordsResponse(BaseModel):
    ...
    usage_metering_daily_records: Optional[List[UsageMeteringDailyRecord]] = Field(default=None, alias="usageMeteringDailyRecords")
    __properties: ClassVar[List[str]] = ["nextOffset", "usageMeteringDailyRecords"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.usage_metering_daily_records:
            for _item_usage_metering_daily_records in self.usage_metering_daily_records:
                if _item_usage_metering_daily_records:
                    _items.append(_item_usage_metering_daily_records.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usageMeteringDailyRecords": [UsageMeteringDailyRecord.from_dict(_item) for _item in obj["usageMeteringDailyRecords"]] if obj.get("usageMeteringDailyRecords") is not None else None
        })
        return _obj
