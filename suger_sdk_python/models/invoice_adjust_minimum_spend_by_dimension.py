...
class InvoiceAdjustMinimumSpendByDimension(BaseModel):
    """
    InvoiceAdjustMinimumSpendByDimension
    """ # noqa: E501
    dimension_key: Optional[StrictStr] = Field(default=None, alias="dimensionKey")
    minimum_spend: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minimumSpend")
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["dimensionKey", "minimumSpend", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minimumSpend": obj.get("minimumSpend"),
