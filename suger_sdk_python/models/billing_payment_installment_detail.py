...
class BillingPaymentInstallmentDetail(BaseModel):
    """
    BillingPaymentInstallmentDetail
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    charge_on: Optional[datetime] = Field(default=None, alias="chargeOn")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["amount", "chargeOn", "description"]
