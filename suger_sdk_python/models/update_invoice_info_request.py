...
class UpdateInvoiceInfoRequest(BaseModel):
    """
    UpdateInvoiceInfoRequest
    """ # noqa: E501
    discount_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="discountAmount")
    discount_type: Optional[BillingDiscountType] = Field(default=None, description="The overall discount of the invoice.", alias="discountType")
    due_date: Optional[StrictStr] = Field(default=None, alias="dueDate")
    memo: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["discountAmount", "discountType", "dueDate", "memo"]
