...
class ClientDescribeInstanceResponseBodyModules(BaseModel):
    ...
    """ # noqa: E501
    module: Optional[List[ClientDescribeInstanceResponseBodyModulesModule]] = Field(default=None, alias="Module")
    __properties: ClassVar[List[str]] = ["Module"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Module": [ClientDescribeInstanceResponseBodyModulesModule.from_dict(_item) for _item in obj["Module"]] if obj.get("Module") is not None else None
        })
        return _obj
