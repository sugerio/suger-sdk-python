...
class AzureMarketState(BaseModel):
    ...
    AzureMarketState
    """ # noqa: E501
    market_code: Optional[StrictStr] = Field(default=None, description="ISO Country Code", alias="marketCode")
    state: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["marketCode", "state"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['Disabled', 'Enabled', 'StopSelling', 'Terminated']):
