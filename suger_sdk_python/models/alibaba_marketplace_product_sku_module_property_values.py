...
class AlibabaMarketplaceProductSkuModulePropertyValues(BaseModel):
    ...
    """ # noqa: E501
    property_value: Optional[List[AlibabaMarketplaceProductSkuModulePropertyValue]] = Field(default=None, alias="PropertyValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyValue": [AlibabaMarketplaceProductSkuModulePropertyValue.from_dict(_item) for _item in obj["PropertyValue"]] if obj.get("PropertyValue") is not None else None
        })
        return _obj
