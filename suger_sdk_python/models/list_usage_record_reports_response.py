...
class ListUsageRecordReportsResponse(BaseModel):
    ...
    usage_record_reports: Optional[List[MeteringUsageRecordReport]] = Field(default=None, alias="usageRecordReports")
    __properties: ClassVar[List[str]] = ["nextOffset", "usageRecordReports"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.usage_record_reports:
            for _item_usage_record_reports in self.usage_record_reports:
                if _item_usage_record_reports:
                    _items.append(_item_usage_record_reports.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usageRecordReports": [MeteringUsageRecordReport.from_dict(_item) for _item in obj["usageRecordReports"]] if obj.get("usageRecordReports") is not None else None
        })
        return _obj
