...
class BillableMetricFilterGroup(BaseModel):
    """
    BillableMetricFilterGroup
    """ # noqa: E501
    filters: Optional[List[BillableMetricFilter]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [BillableMetricFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
