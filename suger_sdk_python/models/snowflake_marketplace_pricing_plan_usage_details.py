...
class SnowflakeMarketplacePricingPlanUsageDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["free_unit_kind", "free_units", "max_fee", "usage_unit_kind", "usage_unit_price"]
