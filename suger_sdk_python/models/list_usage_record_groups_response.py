...
class ListUsageRecordGroupsResponse(BaseModel):
    ...
    usage_record_groups: Optional[List[MeteringUsageRecordGroup]] = Field(default=None, alias="usageRecordGroups")
    __properties: ClassVar[List[str]] = ["nextOffset", "usageRecordGroups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.usage_record_groups:
            for _item_usage_record_groups in self.usage_record_groups:
                if _item_usage_record_groups:
                    _items.append(_item_usage_record_groups.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usageRecordGroups": [MeteringUsageRecordGroup.from_dict(_item) for _item in obj["usageRecordGroups"]] if obj.get("usageRecordGroups") is not None else None
        })
        return _obj
