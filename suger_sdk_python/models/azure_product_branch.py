...
class AzureProductBranch(BaseModel):
    ...
    AzureProductBranch
    """ # noqa: E501
    current_draft_instance_id: Optional[StrictStr] = Field(default=None, alias="currentDraftInstanceID")
    ...
    __properties: ClassVar[List[str]] = ["currentDraftInstanceID", "friendlyName", "id", "module", "resourceType", "type", "variantID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentDraftInstanceID": obj.get("currentDraftInstanceID"),
