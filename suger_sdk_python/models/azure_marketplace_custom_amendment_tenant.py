...
class AzureMarketplaceCustomAmendmentTenant(BaseModel):
    ...
    """ # noqa: E501
    manual_entries: Optional[List[AzureMarketplaceCustomAmendmentTenantManualEntry]] = Field(default=None, alias="manualEntries")
    __properties: ClassVar[List[str]] = ["manualEntries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.manual_entries:
            for _item_manual_entries in self.manual_entries:
                if _item_manual_entries:
                    _items.append(_item_manual_entries.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "manualEntries": [AzureMarketplaceCustomAmendmentTenantManualEntry.from_dict(_item) for _item in obj["manualEntries"]] if obj.get("manualEntries") is not None else None
        })
        return _obj
