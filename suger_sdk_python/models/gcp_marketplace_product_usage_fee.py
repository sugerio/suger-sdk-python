...
class GcpMarketplaceProductUsageFee(BaseModel):
    ...
    """ # noqa: E501
    display_quantity: Optional[StrictInt] = Field(default=None, description="such as 1", alias="displayQuantity")
    metric_id: Optional[StrictStr] = Field(default=None, description="such as \"Starter_storage\"", alias="metricId")
    price_tiers: Optional[List[GcpPriceTier]] = Field(default=None, alias="priceTiers")
    __properties: ClassVar[List[str]] = ["displayQuantity", "metricId", "priceTiers"]
