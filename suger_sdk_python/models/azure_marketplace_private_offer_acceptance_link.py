...
class AzureMarketplacePrivateOfferAcceptanceLink(BaseModel):
    ...
    """ # noqa: E501
    beneficiary_id: Optional[StrictStr] = Field(default=None, description="The Customer Billing Account ID.", alias="beneficiaryId")
    link: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["beneficiaryId", "link"]
