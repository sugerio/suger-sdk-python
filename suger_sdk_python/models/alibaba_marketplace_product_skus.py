...
class AlibabaMarketplaceProductSkus(BaseModel):
    ...
    """ # noqa: E501
    product_sku: Optional[List[AlibabaMarketplaceProductSku]] = Field(default=None, alias="ProductSku")
    __properties: ClassVar[List[str]] = ["ProductSku"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.product_sku:
            for _item_product_sku in self.product_sku:
                if _item_product_sku:
                    _items.append(_item_product_sku.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ProductSku": [AlibabaMarketplaceProductSku.from_dict(_item) for _item in obj["ProductSku"]] if obj.get("ProductSku") is not None else None
        })
        return _obj
