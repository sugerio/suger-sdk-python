...
class PriceModelTiered(BaseModel):
    """
    PriceModelTiered
    """ # noqa: E501
    tiers: Optional[List[PriceModelTieredConfig]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tiers": [PriceModelTieredConfig.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None
        })
        return _obj
