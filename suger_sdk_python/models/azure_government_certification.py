...
class AzureGovernmentCertification(BaseModel):
    ...
    validation_results: Optional[List[AzureValidationResult]] = Field(default=None, alias="validationResults")
    __properties: ClassVar[List[str]] = ["title", "uri", "validationResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "uri": obj.get("uri"),
            "validationResults": [AzureValidationResult.from_dict(_item) for _item in obj["validationResults"]] if obj.get("validationResults") is not None else None
        })
        return _obj
