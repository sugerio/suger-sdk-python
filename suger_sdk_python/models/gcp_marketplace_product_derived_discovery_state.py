...
class GcpMarketplaceProductDerivedDiscoveryState(BaseModel):
    ...
    """ # noqa: E501
    access_state: Optional[GcpMarketplaceProductAccessState] = Field(default=None, alias="accessState")
    search_state: Optional[StrictStr] = Field(default=None, alias="searchState")
    __properties: ClassVar[List[str]] = ["accessState", "searchState"]

    @field_validator('search_state')
    def search_state_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['ADMIN_OVERRIDE_UNSEARCHABLE', 'SEARCHABLE']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchState": obj.get("searchState")
        })
        return _obj
