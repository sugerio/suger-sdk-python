...
class AlibabaMarketplaceProductSkuModuleProperties(BaseModel):
    ...
    """ # noqa: E501
    var_property: Optional[List[AlibabaMarketplaceProductSkuModuleProperty]] = Field(default=None, alias="Property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": [AlibabaMarketplaceProductSkuModuleProperty.from_dict(_item) for _item in obj["Property"]] if obj.get("Property") is not None else None
        })
        return _obj
