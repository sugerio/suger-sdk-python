...
class GcpMarketplacePrivateOfferMigrationMetadata(BaseModel):
    ...
    provider_id: Optional[StrictStr] = Field(default=None, description="The GCP project ID of the provider.", alias="providerId")
    __properties: ClassVar[List[str]] = ["inventoryFlavorExternalName", "productExternalName", "projectNumber", "providerId"]
