...
class GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibIdentityApiClient(BaseModel):
    """
    GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibIdentityApiClient
    """ # noqa: E501
    api_key_hash: Optional[StrictStr] = Field(default=None, alias="apiKeyHash")
    creation_time: Optional[StrictStr] = Field(default=None, alias="creationTime")
    id: Optional[StrictStr] = None
    info: Optional[List[StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["apiKeyHash", "creationTime", "id", "info", "lastUpdateTime", "organizationID", "provider", "role", "secret", "type"]
