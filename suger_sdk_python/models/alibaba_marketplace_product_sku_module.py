...
class AlibabaMarketplaceProductSkuModule(BaseModel):
    ...
    properties: Optional[AlibabaMarketplaceProductSkuModuleProperties] = Field(default=None, alias="Properties")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Name": obj.get("Name"),
            "Properties": AlibabaMarketplaceProductSkuModuleProperties.from_dict(obj["Properties"]) if obj.get("Properties") is not None else None
        })
        return _obj
