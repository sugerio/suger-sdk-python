...
class AzureMarketplacePriceAndAvailabilitySoftwareReservation(BaseModel):
    ...
    """ # noqa: E501
    percentage_save: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="default 0", alias="percentageSave")
    term: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="default 0")
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["percentageSave", "term", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "percentageSave": obj.get("percentageSave"),
            "term": obj.get("term"),
            "type": obj.get("type")
        })
        return _obj
