...
class SnowflakeMarketplaceOfferTermsOfService(BaseModel):
    """
    SnowflakeMarketplaceOfferTermsOfService
    """ # noqa: E501
    custom_link: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["custom_link", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "custom_link": obj.get("custom_link"),
            "type": obj.get("type")
        })
        return _obj
