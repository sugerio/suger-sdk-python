...
class GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventConflictResponseAdditionalInfo(BaseModel):
    ...
    """ # noqa: E501
    accepted_message: Optional[GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventOkResponse] = Field(default=None, alias="acceptedMessage")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acceptedMessage": GithubComSugerioMarketplaceServiceAzureSdkMarketplacemeteringv1UsageEventOkResponse.from_dict(obj["acceptedMessage"]) if obj.get("acceptedMessage") is not None else None
        })
        return _obj
