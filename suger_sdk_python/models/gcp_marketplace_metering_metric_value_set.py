...
class GcpMarketplaceMeteringMetricValueSet(BaseModel):
    """
    GcpMarketplaceMeteringMetricValueSet
    """ # noqa: E501
    metric_name: Optional[StrictStr] = Field(default=None, description="MetricName: The metric name defined in the service configuration.", alias="metricName")
    metric_values: Optional[List[GcpMarketplaceMeteringMetricValue]] = Field(default=None, description="MetricValues: The values in this metric.", alias="metricValues")
    __properties: ClassVar[List[str]] = ["metricName", "metricValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metricValues": [GcpMarketplaceMeteringMetricValue.from_dict(_item) for _item in obj["metricValues"]] if obj.get("metricValues") is not None else None
        })
        return _obj
