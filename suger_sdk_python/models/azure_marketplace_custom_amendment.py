...
class AzureMarketplaceCustomAmendment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenants", "terms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tenants": AzureMarketplaceCustomAmendmentTenant.from_dict(obj["tenants"]) if obj.get("tenants") is not None else None,
            "terms": obj.get("terms")
        })
        return _obj
