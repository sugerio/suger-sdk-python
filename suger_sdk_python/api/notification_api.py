...
class NotificationApi:
    ...
    def get_notification_message(
        ...
        notification_message_id: Annotated[StrictStr, Field(description="Notification Message ID")],
        ...
        _param = self._get_notification_message_serialize(
            org_id=org_id,
    ...
    @validate_call
    def get_notification_message_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        notification_message_id: Annotated[StrictStr, Field(description="Notification Message ID")],
        _request_timeout: Union[
    ...
    def _get_notification_message_serialize(
        self,
        org_id,
        ...
        if notification_message_id is not None:
            _path_params['notificationMessageId'] = notification_message_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/notificationMessage/{notificationMessageId}',
    ...
    def list_notification_events(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListNotificationEventsResponse",
            '400': "str",
            '500': "str",
        }
        response_data = self.api_client.call_api(
    ...
    def list_notification_events_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListNotificationEventsResponse]:
        """list notification events
    ...
    def _list_notification_events_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/notificationEvent',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_notification_events_by_entity(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        entity_type: Annotated[StrictStr, Field(description="Entity type, valid values are: PRODUCT, OFFER, ENTITLEMENT, INTEGRATION etc.")],
        ...
        :param org_id: Organization ID (required)
        :type org_id: str
        :param entity_type: Entity type, valid values are: PRODUCT, OFFER, ENTITLEMENT, INTEGRATION etc. (required)
        ...
        _param = self._list_notification_events_by_entity_serialize(
            org_id=org_id,
    ...
    @validate_call
    def list_notification_events_by_entity_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        entity_type: Annotated[StrictStr, Field(description="Entity type, valid values are: PRODUCT, OFFER, ENTITLEMENT, INTEGRATION etc.")],
        entity_id: Annotated[StrictStr, Field(description="Entity ID")],
    ...
    @validate_call
    def list_notification_events_by_entity_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        entity_type: Annotated[StrictStr, Field(description="Entity type, valid values are: PRODUCT, OFFER, ENTITLEMENT, INTEGRATION etc.")],
        entity_id: Annotated[StrictStr, Field(description="Entity ID")],
    ...
    def _list_notification_events_by_entity_serialize(
        self,
        org_id,
        entity_type,
        entity_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/notificationEvent/{entityType}/{entityId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_notification_messages_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        limit: Annotated[Optional[StrictInt], Field(description="List pagination size, default 1000, max value is 1000")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="List pagination offset, default 0")] = None,
    ...
    def _list_notification_messages_serialize(
        self,
        org_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{orgId}/notificationMessage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
