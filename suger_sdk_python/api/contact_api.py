...
class ContactApi:
    ...
    def add_contact_to_buyer(
        ...
        _param = self._add_contact_to_buyer_serialize(
            org_id=org_id,
            buyer_id=buyer_id,
    ...
    @validate_call
    def add_contact_to_buyer_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        buyer_id: Annotated[StrictStr, Field(description="Buyer ID")],
        contact_id: Annotated[StrictStr, Field(description="Contact ID")],
    ...
    def _add_contact_to_buyer_serialize(
        self,
        org_id,
        buyer_id,
        contact_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/contact/{contactId}/buyer/{buyerId}',
    ...
    def add_contact_to_offer(
        ...
        _param = self._add_contact_to_offer_serialize(
            org_id=org_id,
            contact_id=contact_id,
            offer_id=offer_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def add_contact_to_offer_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        contact_id: Annotated[StrictStr, Field(description="Contact ID")],
        offer_id: Annotated[StrictStr, Field(description="Offer ID")],
    ...
    def _add_contact_to_offer_serialize(
        self,
        org_id,
        contact_id,
        offer_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/contact/{contactId}/offer/{offerId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def batch_create_contacts(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        data: Annotated[List[IdentityContact], Field(description="RequestBody")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type data: List[IdentityContact]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._batch_create_contacts_serialize(
            org_id=org_id,
            data=data,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def batch_create_contacts_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        data: Annotated[List[IdentityContact], Field(description="RequestBody")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[List[IdentityContact]]]:
        """batch create contacts
    ...
    @validate_call
    def batch_create_contacts_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        data: Annotated[List[IdentityContact], Field(description="RequestBody")],
        _request_timeout: Union[
    ...
    def _batch_create_contacts_serialize(
        self,
        org_id,
        data,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/org/{orgId}/contact/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_contact_from_buyer(
        ...
        _param = self._remove_contact_from_buyer_serialize(
            org_id=org_id,
            buyer_id=buyer_id,
            contact_id=contact_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_contact_from_buyer_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        buyer_id: Annotated[StrictStr, Field(description="Buyer ID")],
        contact_id: Annotated[StrictStr, Field(description="Contact ID")],
    ...
    def _remove_contact_from_buyer_serialize(
        self,
        org_id,
        buyer_id,
        contact_id,
    ...
    def remove_contact_from_offer(
        ...
        _param = self._remove_contact_from_offer_serialize(
            org_id=org_id,
            contact_id=contact_id,
            offer_id=offer_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_contact_from_offer_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="Organization ID")],
        contact_id: Annotated[StrictStr, Field(description="Contact ID")],
        offer_id: Annotated[StrictStr, Field(description="Offer ID")],
    ...
    def _remove_contact_from_offer_serialize(
        self,
        org_id,
        contact_id,
        offer_id,
